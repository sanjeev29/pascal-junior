...
typedef FUNCTION_POINTER(int, DLinkApply3Func,
 (DLinkNode *node, Generic arg1, Generic arg2, Generic arg3));
EXTERN(void, dlinkApply3,
 (DLinkList *list, DLinkApply3Func func, Generic arg1, Generic arg2, Generic arg3));

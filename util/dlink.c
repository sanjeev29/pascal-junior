 ...
 *
 * Applies `func' to every node in `list', passing `arg1' as the second
 * argument to `func', `arg2' as the third, and `arg3` as the fourth.
 *
 * @param list a linked list
 * @param func a function to be applied to every list node
 * @param arg1 the second argument to each 'func' call
 * @param arg2 the third argument to each 'func' call
 * @param arg2 the fourth argument to each 'func' call
 */
void
dlinkApply3(DLinkList *list, DLinkApply3Func func, Generic arg1, Generic arg2, Generic arg3)
{
        DLinkNode *temp = list->head;
